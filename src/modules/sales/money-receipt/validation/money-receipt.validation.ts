...
// ==========================================================
// MONEY RECEIPT FORM SCHEMA
// ==========================================================

export const moneyReceiptFormSchema = z
  .object({
    // ------------------------------------------------------
    // RECEIPT DATE
    // ------------------------------------------------------
...
export type MoneyReceiptFormValues =
  z.input<
    typeof moneyReceiptFormSchema
  >;

export type MoneyReceiptFormOutput =
  z.output<
    typeof moneyReceiptFormSchema
  >;
